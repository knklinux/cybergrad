  ...
  dominios: {
    "upload.personal-stash.net": {
      ...
      whois: [
        ...
        "No está en la lista blanca de servicios aprobados de ACME.",
      ].join("\n"),
      vt: {
        repos: 17,
        maliciosos: 2,
    ...
    "dropbox.com": {
      ...
      whoi: "Servicio de almacenamiento legítimo y aprobado por ACME. Nada sospechoso aquí.",
