...
export const BEC01 = {
  ...
  fs: {
    "/opt/siem/alerts.json": [
      ...
      '      "from": "facturacion@cibercorp-facturas.info",',
      '      "detail": "El dominio cibercorp-facturas.info imita a cibercorp.com (lookalike). Adjunto .docm con macros. Posible phishing."',
      "    }",
      "  ]",
      "}",
    ].join("\n"),
    "/home/analista/casos/evidencias/headers.txt": [
      ...
      "  - La dirección legítima de facturación es facturacion@cibercorp.com.",
    ].join("\n"),
  },
  correos: [
    {
  ...
  dominios: {
    "cibercorp-facturas.info": {
      ...
      whois: [
        ...
        "Nota: dominio registrado hace 2 días para imitar a cibercorp.com. Suplantación clara.",
      ].join("\n"),
    },
  },
  correctas: {
    ...
    pasos: [
      {
        ...
        ok: "¡Bien! Has abierto el correo. Fíjate en el remitente: facturacion@cibercorp-facturas.info. El dominio real de CiberCorp es cibercorp.com… «cibercorp-facturas.info» lo imita. Ese es tu primer indicio.",
      ...
      },
      {
        ...
        msg: "Ahora investiga al responsable: el dominio del remitente. Escribe `whois cibercorp-facturas.info`.",
        fallback: "Este paso es consultar el SIEM: escribe `alertas`.",
      },
      {
        cmd: "whois",
        tipo: "comando",
        ejemplo: "whois cibercorp-facturas.info",
        ...
        ok: "Ahí lo tienes: registrado hace 2 DÍAS, con registrador anónimo y datos ocultos. Los dominios legítimos de CiberCorp tienen 22 años y datos visibles. Confirmado: es malicioso.",
        msg: "Hora de actuar. Primero, corta el canal de entrega: bloquea el dominio. Escribe `bloquear cibercorp-facturas.info`.",
        fallback: "Este paso es investigar el dominio: escribe `whois cibercorp-facturas.info`.",
      },
      {
        cmd: "bloquear",
        tipo: "bloquear",
        objetivo: "cibercorp-facturas.info",
        ejemplo: "bloquear cibercorp-facturas.info",
        ...
        ok: "¡Perfecto! Dominio bloqueado: cibercorp-facturas.info ya no puede llegar a nadie de CiberCorp. Primer indicador neutralizado.",
        msg: "Ahora el equipo afectado: el host donde se abrió el adjunto. Escribe `aislar HOST-104`.",
        fallback: "Casi. Bloquea el dominio malicioso del remitente: `bloquear cibercorp-facturas.info` (NO cibercorp.com, que es legítimo).",
      },
      {
        cmd: "aislar",
        tipo: "aislar",
...
export const BECRT01 = {
  ...
  xp: 0,
  briefing:
    "Práctica guiada RED TEAM: CiberCorp te ha firmado un contrato de pentest sobre su servidor de backups 10.10.10.20. En este modo te llevo de la mano por las fases ofensivas: leer el contrato, reconocer con nmap, enumerar la web, romper la puerta con hydra, entrar por SSH y documentar el hallazgo. En cada paso te digo el porqué. Sin prisa, sin penalizaciones. Escribe `ver_caso` para empezar.",
  red: {
    hosts: {
      "10.10.10.20": {
  ...
  web: {
    "http://10.10.10.20": {
      raiz: "<html><head><title>CiberCorp - Backup portal</title></head><body><h1>Portal de backups</h1><p>Acceso restringido.</p></body></html>",
